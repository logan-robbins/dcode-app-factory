...
## Implementation progress (code changes)

- [x] Add filesystem-backed project state store and persist `state_machine/state.json`. **COMPLETE**
- [x] Add deterministic `declaration_order` for tasks in persisted state snapshots. **COMPLETE**
- [x] Add legal transition validator for task state changes in the state machine model. **COMPLETE**
- [x] Add minimal artifact envelope model and persist ship-evidence artifacts on successful task execution. **COMPLETE**
- [x] Add automated tests for state persistence, artifact persistence, and illegal transition rejection. **COMPLETE**
